package com.mninetytechnology.mahamillateapp.acitivities.ui.organisation;
...
import com.mninetytechnology.mahamillateapp.databinding.ActivityOrganisationRegistrationBinding;
...
import com.mninetytechnology.mahamillateapp.presenter.OrganisationRegisterPresenter;

import java.text.SimpleDateFormat;
import java.util.Calendar;
import java.util.List;

public class OrganisationRegistrationActivity extends BaseActivity implements OrganisationRegisterContract.ViewModel {
    private ActivityOrganisationRegistrationBinding binding;
    private OrganisationRegisterPresenter presenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this,R.layout.activity_organisation_registration);
        helper = new GlobalHelper(this);
        presenter = new OrganisationRegisterPresenter(this, this);
    ...
    @Override
    public void register(OrganisationLoginObject userLoginObject, String token) {
        try {
    ...
    public void setUpAddress() {
        dialog = new AlertDialog.Builder(OrganisationRegistrationActivity.this).create();
...
//        ArrayAdapter<Division> adapter = new ArrayAdapter<>(OrganisationRegistrationActivity.this, android.R.layout.simple_spinner_dropdown_item,divisions);
...
//    }
    ...
    public void setUpDistrict(List<String> district) {
        ArrayAdapter<String> adapter = new ArrayAdapter<>(OrganisationRegistrationActivity.this, android.R.layout.simple_spinner_dropdown_item, district);
    ...
    public void setUpTaluka(List<String> talukas) {
        ArrayAdapter<String> adapter = new ArrayAdapter<>(OrganisationRegistrationActivity.this, android.R.layout.simple_spinner_dropdown_item, talukas);
    ...
    public void setUpVillage(List<String> village) {
        ArrayAdapter<String> adapter = new ArrayAdapter<>(OrganisationRegistrationActivity.this, android.R.layout.simple_spinner_dropdown_item, village);
...
//                    Toast.makeText(OrganisationRegistrationActivity.this, getResources().getString(R.string.please_select_division), Toast.LENGTH_SHORT).show();
//                }else
                if (presenter.district.get().isEmpty()) {
                    Toast.makeText(OrganisationRegistrationActivity.this, getResources().getString(R.string.please_select_district), Toast.LENGTH_SHORT).show();
                } else if (presenter.taluka.get().isEmpty()) {
                    Toast.makeText(OrganisationRegistrationActivity.this, getResources().getString(R.string.please_select_taluka), Toast.LENGTH_SHORT).show();
                } else if (presenter.village.get().isEmpty()) {
                    Toast.makeText(OrganisationRegistrationActivity.this, getResources().getString(R.string.please_select_village), Toast.LENGTH_SHORT).show();
                } else {

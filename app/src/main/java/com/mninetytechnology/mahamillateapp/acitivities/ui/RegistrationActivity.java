...
//    }
    ...
    public void setUpDistrict(List<District> district) {
        ArrayAdapter<District> adapter = new ArrayAdapter<>(RegistrationActivity.this, android.R.layout.simple_spinner_dropdown_item,district);
    ...
    public void setUpTaluka(List<Taluka> talukas) {
        ArrayAdapter<Taluka> adapter = new ArrayAdapter<>(RegistrationActivity.this, android.R.layout.simple_spinner_dropdown_item,talukas);
    ...
    public void setUpVillage(List<Village> village) {
        ArrayAdapter<Village> adapter = new ArrayAdapter<>(RegistrationActivity.this, android.R.layout.simple_spinner_dropdown_item,village);
